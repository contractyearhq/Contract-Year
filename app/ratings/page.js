      ...
      {nflRatings.length > 0 && (
        <section style={{ borderBottom: '1px solid #2a2a2a' }}>
          ...
          {nflRatings.map(function(rating) {
            return (
              <Link key={rating.slug} href={'/ratings/' + rating.slug} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 120px', padding: '24px 40px', borderBottom: '1px solid #2a2a2a', textDecoration: 'none', alignItems: 'center' }}>
                <div>
