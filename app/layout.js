      ...
      <body className={inter.className}>
        <nav style={{
          ...
          <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
            <a href="/" style={{ fontSize: '13px', color: '#9a9894', textTransform: 'uppercase', letterSpacing: '0.08em', textDecoration: 'none' }}>
              Home
            </a>
            <a href="/teams" style={{ fontSize: '13px', color: '#9a9894', textTransform: 'uppercase', letterSpacing: '0.08em', textDecoration: 'none' }}>
              Teams
            </a>
            <a href="/ratings" style={{ fontSize: '13px', color: '#9a9894', textTransform: 'uppercase', letterSpacing: '0.08em', textDecoration: 'none' }}>
              Ratings
            </a>
