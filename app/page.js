    ...
    <div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          textTransform: 'uppercase', color: '#1D9E75', marginBottom: '20px',
        }}>
        ...
        <h1 style={{
          ...
          Contract<br />
          <span style={{ color: '#1D9E75' }}>Year.</span>
        </h1>
        <p style={{
          fontSize: '18px', color: '#9a9894',
          lineHeight: 1.65, marginBottom: '48px', maxWidth: '480px',
        }}>
          ...
          {[
            ...
            return (
              <span key={v.label} style={{
                border: '1px solid ' + v.color, color: v.color,
        ...
        <div style={{ display: 'flex', gap: '48px' }}>
          <div>
            <div style={{ fontSize: '42px', fontWeight: 900, lineHeight: 1 }}>7</div>
      ...
      <div style={{
        ...
        <span style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#555550' }}>
          Latest Ratings
        </span>
        <span style={{ fontSize: '13px', color: '#555550' }}>
          {ratings ? ratings.length : 0} contracts rated
        </span>
      </div>

      {/* Featured Card */}
      {featured && (
        <Link href={'/ratings/' + featured.slug} style={{
          ...
          <div style={{
            ...
            width: '4px', height: '100%', background: '#007A33',
          }} />
      ...
      <section style={{
        ...
        <div>
          <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#555550', marginBottom: '12px' }}>
            New Feature
          </div>
